...
- Consolidated the FleetMind AWS Terraform module into `infra/terraform/`. User-facing module documentation now lives under [`docs/terraform/`](docs/terraform/README.md); the standalone module repository remains available for historical releases and existing consumers.
