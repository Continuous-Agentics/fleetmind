...
Most operator-facing documentation (bring-up, day-2 ops, troubleshooting, vocabulary, GitHub Apps, multi-fleet, BYO VPC, etc.) lives in this repository and its template companion:
...
| **Module details** (inputs, outputs, BYO VPC, IaC troubleshooting, migrations, standalone task-ledger) | [`Continuous-Agentics/fleetmind`](https://github.com/Continuous-Agentics/fleetmind) → `infra/terraform/docs/` |
