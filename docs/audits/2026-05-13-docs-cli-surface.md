...
| `docs/MULTI-FLEET.md` | Mentioned "AFT vends `carpe-<account-id>-bot-content` in Carpe accounts" — Carpe-internal detail in a public-facing OSS-style doc. | Removed; replaced with generic "Use an existing account-level bucket or create a dedicated one." |
