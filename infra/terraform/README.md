...
> **Canonical location:** This module was consolidated from the historical
> [`Continuous-Agentics/terraform-aws-fleetmind`](https://github.com/Continuous-Agentics/terraform-aws-fleetmind)
> repository into [`Continuous-Agentics/fleetmind//infra/terraform`](https://github.com/Continuous-Agentics/fleetmind/tree/main/infra/terraform).
> Historical releases remain available in the former repository. Equivalent
> imported release refs use the `terraform-aws-fleetmind/v*` namespace in this
> repository; new consumers should use the source shown below.
> **Provenance:** The import is a no-squash unrelated-history merge whose
> second parent is upstream commit `da3a447`; the original annotated tags are
> retained locally under `terraform-aws-fleetmind/v*` with their original tag
> objects. Those historical tags continue to identify the old repository-root
> layout. The first path-aware canonical release is
> `terraform-aws-fleetmind/v1.1.10`, which points at this import.
...
module "fleetmind" {
  source = "github.com/Continuous-Agentics/fleetmind//infra/terraform?ref=terraform-aws-fleetmind/v1.1.10"
